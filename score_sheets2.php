            ...
            <ul class="nav">
              ...
              <li>
                ...
                <?php } else { ?>
                 ...
                 <li> <a href="logout.php">Tabulator: <b><?php echo $tabname ;?></b> - <i>Log out</i></a></li>
...
================================================== -->
<?php if($tabname == "") { ?>
<header class="jumbotron subhead" id="overview" style="background-color: rgb(0, 72, 114); color: white; padding: 20px 0; text-align: center;">
  <div class="container">
    <h1 style="color: #ffffff; margin: 0;">Score Sheets</h1>
    <p class="lead" style="color: #ffffff; margin: 0;">Judging Management System</p>
  </div>
</header>
<?php } else { ?>
<header class="jumbotrontabulator subhead" id="overview" style="background-color: rgb(34, 85, 136); color: white; padding: 20px 0; text-align: center;">
  <div class="container">
    <h1 style="color: #ffffff; margin: 0;">Score Sheets</h1>
    <p class="lead" style="color: #ffffff; margin: 0;">Judging Management System - Tabulator's Panel</p>
  </div>
</header>
<?php } ?>
