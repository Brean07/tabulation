...
================================================== -->
<?php if($tabname==""){ ?>
  <header class="jumbotron subhead text-center" id="overview" style="text-align: center; background-color:rgb(0, 72, 114); padding: 20px;">
  <div class="container">
    <h1>Score Sheets</h1>
...
<header class="jumbotrontabulator subhead text-center" id="overview" style="background-color: rgb(0, 72, 114); padding: 25px 0; text-align: center;">
  <div class="container">
    <h1 style="color: #fff; margin: 0;">Score Sheets</h1>
    <p class="lead" style="color: #fff;">Judging Management System - Tabulator's Panel</p>
  </div>
</header>
<?php } ?>
