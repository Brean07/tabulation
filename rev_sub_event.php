...
<header class="jumbotron subhead" id="overview" style="background-color: rgb(0, 72, 114); color: white; text-align: center; padding: 20px 0;">
  <div class="container">
    <h1 style="margin: 0;">Data Reviews</h1>
