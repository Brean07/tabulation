...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2025 at 06:09 AM
...
(21, 'Contestant 1', 6, 1, '', '', 177696, 0),
(22, 'Contestant 2', 6, 2, '', '', 182029, 0),
(23, 'Contestant 3', 6, 3, '', '', 8619033, 0),
(24, 'Contestant 4', 6, 4, '', '', 8619034, 0),
(25, 'Contestant 5', 6, 5, '', '', 8619035, 0),
(26, 'Contestant 6', 6, 6, '', '', 8619036, 0),
(27, 'Contestant 7', 6, 7, '', '', 8619037, 0),
(28, 'Contestant 8', 6, 8, '', '', 8619038, 0),
(29, 'Contestant 1', 7, 1, '', '', 285447, 0),
(30, 'Contestant 2', 7, 2, '', '', 305971, 0),
(31, 'Contestant 3', 7, 3, '', '', 6887173, 0),
(32, 'Contestant 4', 7, 4, '', '', 6887174, 0),
(33, 'Contestant 5', 7, 5, '', '', 6887175, 0),
(34, 'Contestant 6', 7, 6, '', '', 6887176, 0),
(35, 'Contestant 7', 7, 7, '', '', 6887177, 0),
(36, 'Contestant 8', 7, 8, '', '', 6887178, 0),
(37, 'Contestant 1', 8, 1, '', '', 235642, 0),
(38, 'Contestant 2', 8, 2, '', '', 634871, 0),
(39, 'Contestant 3', 8, 3, '', '', 2872563, 0),
(40, 'Contestant 4', 8, 4, '', '', 2872564, 0),
(41, 'Contestant 5', 8, 5, '', '', 2872565, 0),
(42, 'Contestant 6', 8, 6, '', '', 2872566, 0),
(43, 'Contestant 7', 8, 7, '', '', 2872567, 0),
(44, 'Contestant 8', 8, 8, '', '', 2872568, 0),
(45, 'Contestant 1', 9, 1, '', '', 985517, 0),
(46, 'Contestant 2', 9, 2, '', '', 628748, 0),
(47, 'Contestant 3', 9, 3, '', '', 3122183, 0),
(48, 'Contestant 4', 9, 4, '', '', 3122184, 0),
(49, 'Contestant 5', 9, 5, '', '', 3122185, 0),
(50, 'Contestant 6', 9, 6, '', '', 3122186, 0),
(51, 'Contestant 7', 9, 7, '', '', 3122187, 0),
(52, 'Contestant 8', 9, 8, '', '', 3122188, 0),
...
--
ALTER TABLE `contestants`
  MODIFY `contestant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
...
--
ALTER TABLE `judges`
  MODIFY `judge_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `main_event`
--
ALTER TABLE `main_event`
  MODIFY `mainevent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `sub_event`
  MODIFY `subevent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `sub_results`
--
ALTER TABLE `sub_results`
  MODIFY `subresult_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
