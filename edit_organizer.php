...
<html lang="en">
  ...
  <body>
    ...
    <header class="jumbotron subhead" id="overview" style="background-color: #30475E; color: whitesmoke; padding: 30px 0; text-align: center;">
  <div class="container">
    <h1 style="margin: 0;">Settings - Organizer</h1>
    <p class="lead" style="margin: 0;">Judging Management System</p>
  </div>
</header>
 ...
 <a href="edit_tabulator.php" class="btn btn-danger"><strong>ORGANIZER SETTINGS &raquo;</strong></a>  
