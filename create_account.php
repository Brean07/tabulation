...
<header class="jumbotron subhead" id="overview" style="background-color: rgb(4, 97, 151); color: white; padding: 25px 0;">
  <div class="container" style="text-align: center;">
    <h1 style="color: #ffffff; margin: 0;">Account Registration</h1>
  ...
  <div class="col-lg-3">
    ...
    <footer>
      ...
      <!--div class="container"-->
        ...
        <center><font size="3" class=""><strong>Judging Management System &middot; &COPY; <?= date ("Y") ?></strong> </font> <br /></center>
