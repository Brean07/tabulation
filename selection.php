...
<header class="jumbotron subhead" id="overview" style="background-color: rgb(0, 72, 114); color: white; padding: 20px 0;">
  <div class="container" style="text-align: center;">
    <h1 style="color: #ffffff; margin: 0;">User Selection Panel</h1>
