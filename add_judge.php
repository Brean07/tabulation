...
<header class="jumbotron subhead" id="overview" style="background-color:rgb(36, 104, 173); color: white; padding: 20px 0; text-align: center;">
  <div class="container">
    <h1 style="margin: 0;"><?php echo $se_name; ?> Settings</h1>
